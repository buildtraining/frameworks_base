...
public class StatusBar extends SystemUI implements DemoMode,
        ...
        ColorExtractor.OnColorsChangedListener, ConfigurationListener, PackageChangedListener, FlashlightController.FlashlightListener {
    ...
    public void start() {
        ...
        mSixSettingsObserver.observe();
        mSixSettingsObserver.update();
    ...
    protected void makeStatusBarView() {
        ...
        filter.addAction(SixUtils.ACTION_DISMISS_KEYGUARD);
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (SixUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(SixUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(SixUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
    ...
    private SixSettingsObserver mSixSettingsObserver = new SixSettingsObserver(mHandler);
    private class SixSettingsObserver extends ContentObserver {
        SixSettingsObserver(Handler handler) {
            super(handler);
        }
